      ...
      <div className="container-x relative z-10">
        <div className="grid md:grid-cols-2 gap-10 md:gap-14 items-center">
          ...
          <div>
            ...
            {/* Bottom CTA — repeat primary action under the trust strip */}
            <div className="mt-6 animate-fade-up" style={{ animationDelay: "0.42s" }}>
              <a
                href={ctaPrimary.href}
                target={ctaPrimary.whatsapp ? "_blank" : undefined}
                rel={ctaPrimary.whatsapp ? "noopener noreferrer" : undefined}
          ...
          {showBeforeAfter ? (
            ...
            <div className="hidden md:flex justify-center items-stretch animate-fade-up" style={{ animationDelay: "0.45s" }}>
              <div
                className="relative w-full max-w-[420px] rounded-[1.5rem] overflow-hidden bg-black border-2 border-[var(--ink)] shadow-xl"
                style={{ aspectRatio: "9/16" }}
              >
                {embedSrc && (
                  <iframe

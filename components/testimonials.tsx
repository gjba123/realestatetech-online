const FEATURED = {
  ...
  name: "Achieng Owino",
  role: "Superhost · Diani · 2 listings",
      ...
      <div className="container-x">
        ...
        <div className="max-w-3xl mb-12 sm:mb-14">
          ...
          <p className="text-base md:text-lg text-[var(--muted)] mt-4 leading-relaxed">
            Real numbers from hosts who shipped a CinemaStay last quarter. No agencies, no paid placements.
          </p>
        </div>
